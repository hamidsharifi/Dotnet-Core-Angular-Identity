...
using Avery.LabelManager.ViewModels;
using DAL;
...
namespace Avery.LabelManager.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from Avery.LabelManager", message);
