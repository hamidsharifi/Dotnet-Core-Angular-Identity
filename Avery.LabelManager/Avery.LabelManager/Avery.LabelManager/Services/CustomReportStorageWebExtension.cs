...
using System.IO;
using System.Linq;
using Avery.LabelManager.DAL;
using Avery.LabelManager.DAL.Models;
using DevExpress.XtraReports.UI;
using Avery.LabelManager.PredefinedReports;

namespace Avery.LabelManager.Services
{
    public class CustomReportStorageWebExtension : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension
    {
        protected AveryDbContext DbContext { get; set; }
        public CustomReportStorageWebExtension(AveryDbContext dbContext) {
        ...
        public override void SetData(XtraReport report, string url) {
            ...
            var reportData = DbContext.Reports.FirstOrDefault(x => x.Name == url);
            if(reportData == null) {
                DbContext.Reports.Add(new Report { Name = url, LayoutData = stream.ToArray() });
            } else {
